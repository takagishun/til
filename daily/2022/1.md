...
WCAG3.0のドラフトはまだコンテンツ作成のプロセスのテスト段階とあるので、概念的は部分と構造などの理解に留めとくべき。中身はWCAG2.2か2.1を見よう。

# 1 月 29 日

## パフォーマンス

フロントエンドのパフォーマンスについて詳しくなりたい。chrome dev toolsのperformanceタブの見方が全くわからなかったが、本家のドキュメントがちゃんとあったので読んでみる。
...
WCAG3.0のプロジェクト名はSilver。  
構造: 3つのレベルのコンテンツとそれに関連する文書がある

- [ガイドラインの構造](https://www.w3.org/TR/2021/WD-wcag-3.0-20211207/#outcomes)
  - WCAGのコアになる部分。いくつかのトピックに分かれる。
  - 特定技術に依存しない記述
  - 専門家や技術者以外の人たちにも理解しやすいもの
- Outcomes(結果)
  - WCAG2系の達成基準に相当するもの
  - [WCAG2系との違い](https://www.w3.org/TR/2021/WD-wcag-3.0-20211207/#outcomes)
    - 専門家以外も理解できる平易な言葉で書いてある
    - テストの柔軟性がある。2系は真偽値でのチェックだった?
- メソッド
  - WCAG2.Xテクニックに相当するもの
...
2020/02/27 WCAG2.2 WD発行  
2021/06/21 WCAG2.2 WD更新    
2021/01/21 WCAG3.0 WD発行  
...
WCAG2.1と比べて、
- 対応障害区分が広くなった
- 対応端末増えた(ウェアブル機器やWeb of Things機器など)
