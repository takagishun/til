...
WCAG3.0のプロジェクトリポジトリ。issueとかPR見ればどういう方向に向かっているのかわかる。 ガイドラインの更新作業中のものはhttps://w3c.github.io/silver/guidelines/ にホストされている
...
- モーダルダイアログの場合は aria-modal: true をつける
  ...
  - タブ操作ではモーダル外にフォーカスが移動しちゃうので別途対応必要。dialogタグで対応可能っぽいがブラウザ対応状況が悪い
