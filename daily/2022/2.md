...
WAIとは、 Web Accessibility Initiativeの略で、W3Cのイニシアチブ。世界中の組織と協力して、Webのアクセシビリティを追求している。

WAIのドキュメント
https://www.w3.org/WAI/about/

WAIの中でさらにいくつかのWGに分かれている。

- Accessibility Guidelines Working Group (AG WG)
- Accessible Rich Internet Applications (ARIA) Working Group

※ https://www.w3.org/groups/wg/ Working Groupとは一つの仕様を策定するための作業グループで、W3Cの会員、諮問委員会の代表が選出した人、招聘されたエキスパート(Invited Experts)
、W3Cのスタッフで構成される
